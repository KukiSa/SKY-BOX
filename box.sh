...
function speedtest-linux(){
	wget -O "/usr/local/bin/speedtest" "https://raw.githubusercontent.com/BlueSkyXN/ChangeSource/master/speedtest" --no-check-certificate -T 30 -t 5 -d
...
function clonesh(){
	wget -O "/usr/local/bin/rclone" "https://raw.githubusercontent.com/BlueSkyXN/RcloneX/master/rclone" --no-check-certificate -T 30 -t 5 -d
	wget -O "/usr/local/bin/fclone" "https://raw.githubusercontent.com/BlueSkyXN/RcloneX/master/fclone" --no-check-certificate -T 30 -t 5 -d
...
function gettrace(){
	wget -O "/usr/local/bin/besttrace" "https://raw.githubusercontent.com/BlueSkyXN/ChangeSource/master/besttrace" --no-check-certificate -T 30 -t 5 -d
...
function start_menu(){
    ...
    green " USE:  wget -O box.sh https://raw.githubusercontent.com/KukiSa/SKY-BOX/main/box.sh && chmod +x box.sh && clear && ./box.sh "
    yellow " =================================================="
